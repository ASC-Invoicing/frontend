...
const Signup = () => {
    ...
    const handleSignIn = () => {
        ...
        setTimeout(() => {
            setIsLoading(false);
            console.log('Sign Up successful/failed');
        }, 2000);
    };
        ...
        <div className="min-h-screen flex items-center justify-center p-4 font-sans">
            <div className="bg-white p-8 sm:p-10 shadow-xl rounded-xl max-w-md w-full transition-all duration-300">
                ...
                <div className="space-y-4">
                    ...
                    <label className="block text-sm font-medium text-gray-700 pt-2">Confirm Password</label>
                    <Input
                        icon={<Lock className="w-5 h-5" />}
                        placeholder="********"
                        type="password"
                ...
                <div className="flex justify-end items-center mt-6 text-sm">
                    <div className="text-gray-500">
                        ...
                        <Link to={'/login'} className="font-semibold text-firs-dark hover:text-firs-dark/80 ml-1" style={{ color: FIRS_BLUE }}>
                            Log In
                        </Link>
                    </div>
                </div>
